...
setup(
    ...
    project_urls={
        'Documentation': 'https://pyunbaffled.readthedocs.io/',
        'Changelog':
        'https://pyunbaffled.readthedocs.io/en/latest/changelog.html',
        'Issue Tracker': 'https://github.com/seetdev/pyunbaffled/issues',
    },
    keywords=[
